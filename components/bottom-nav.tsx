      ...
      {TABS.map(({ href, icon: Icon, label }) => {
        ...
        return (
          <Link
            key={href}
            href={href}
            className="flex flex-col items-center gap-0.5 py-3 px-5 transition-all duration-200"
          ...
          >
            ...
            />
            <span
              className="text-[0.6rem] font-semibold tracking-wide transition-all duration-200"
