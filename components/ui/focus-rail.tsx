...
export function FocusRail({
  ...
  // Notify parent whenever the visible index changes
  React.useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
          ...
          {visibleIndices.map((offset) => {
            ...
            return (
              <motion.div
                ...
                transition={BASE_SPRING as object}
        ...
        {/* Info & nav */}
        <div className="mx-auto mt-10 flex w-full max-w-4xl flex-col items-center justify-between gap-4 md:flex-row pointer-events-auto">
          <div className="flex flex-1 flex-col items-center text-center md:items-start md:text-left h-24 justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                {activeItem.meta && (
                  <span className="text-lg font-light" style={{ fontFamily: "Georgia, serif", direction: "rtl", color: "#ffffff99" }}>
                    {activeItem.meta}
                  </span>
                )}
