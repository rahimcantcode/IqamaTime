...
export const MORNING_ADHKAR_DETAIL: DhikrDetail = {
  ...
  sequence: [
    { id: 'morning-seq-quls', title: 'Three Quls', description: 'Begin with al-Ikhlas, al-Falaq, and an-Nas.', tag: '3x' },
    { id: 'morning-seq-sayyid', title: 'Sayyid al-Istighfar', description: 'Renew repentance and ask Allah for forgiveness.', tag: '1x' },
    { id: 'morning-seq-protection', title: 'Protection adhkar', description: 'Read the morning protection duas.', tag: '3x' },
    { id: 'morning-seq-tasbih', title: 'SubhanAllahi wa bihamdih', description: 'Finish with abundant tasbih.', tag: '100x' },
  ],
  items: [
    {
...
export const EVENING_ADHKAR_DETAIL: DhikrDetail = {
  ...
  sequence: [
    { id: 'evening-seq-quls', title: 'Three Quls', description: 'Begin with al-Ikhlas, al-Falaq, and an-Nas.', tag: '3x' },
    { id: 'evening-seq-sayyid', title: 'Sayyid al-Istighfar', description: 'Renew repentance before the night.', tag: '1x' },
    { id: 'evening-seq-protection', title: 'Protection adhkar', description: 'Read the evening protection duas.', tag: '3x' },
    { id: 'evening-seq-tasbih', title: 'SubhanAllahi wa bihamdih', description: 'Finish with abundant tasbih.', tag: '100x' },
  ],
  items: [
    {
